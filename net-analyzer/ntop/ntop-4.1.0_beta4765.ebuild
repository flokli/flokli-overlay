...
inherit eutils autotools subversion versionator

DESCRIPTION="Network traffic analyzer with web interface"
HOMEPAGE="http://www.ntop.org/ntop.html"
#SRC_URI="mirror://sourceforge/ntop/${P}.tgz"
SRC_URI=""
REV_COMPONENTS=($(get_version_components))
BETA_REV=${REV_COMPONENTS[3]#beta}
ESVN_REPO_URI="https://svn.ntop.org/svn/ntop/trunk/ntop@${BETA_REV}"
