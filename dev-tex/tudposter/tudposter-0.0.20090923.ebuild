...
DESCRIPTION="LaTeX document class for posters following the TUD-Design"
...
src_install() {
	...
	POSTER_SRC="${TEX_SRC}/latex/tuddesign/poster
				${TEX_SRC}/latex/tuddesign/tudposter.cls"

	dodir ${TUDDESIGN_DST_DIR}
	cp -R ${POSTER_SRC} ${D}/${TUDDESIGN_DST_DIR} \
		|| die failed to copy poster
	...
	if use examples ; then
		...
		dodir ${EXAMPLES_DIR}
		cp examples/tudposter/* ${D}/${EXAMPLES_DIR} || die failed to copy examples
	fi
}
